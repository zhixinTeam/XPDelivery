...
const
  ...
  cFI_FormGetNCPoundData= $1010;                     //获取NC磅单数据
...
type
  TSysParam = record
    ...
    FCompanyID  : string;                            //本机所在公司
    FCompanyName: string;                            //公司名称
    FRecentDays : Integer;                           //可查询时间统计
  end;
  //系统参数
...
begin
  ...
  AddMenuModuleItem('MAIN_A02', cFI_FrameViewLog);
  ...
  AddMenuModuleItem('MAIN_B01', cFI_FrameBuildCard);
end;
